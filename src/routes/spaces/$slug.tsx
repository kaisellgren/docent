...
function PageView() {
  ...
  async function uploadAttachment(event: FormEvent<HTMLFormElement>) {
    ...
    if (selectedFiles.length === 0) { setError('Choose or drop one or more files first.'); return; }
