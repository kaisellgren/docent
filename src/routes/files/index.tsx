...
export const Route = createFileRoute('/files/')({ loader: async () => ({ viewer: await getViewer(), files: await getFiles(), folders: await getFolders() }), component: FilesPage });
